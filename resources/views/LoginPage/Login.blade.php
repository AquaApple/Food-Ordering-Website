            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="{{asset('LoginPage/images/signin-image.jpg')}}" alt="sign up image"></figure>
                        <a href="{{route('user.signup')}}" class="signup-image-link">Create an account</a>
                    </div>
    ...
    @include('LoginPage.Includes.Footer')
